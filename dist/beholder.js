...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Raptor = __webpack_require__(213);
	
	var _Raptor2 = _interopRequireDefault(_Raptor);
	
	var _Log = __webpack_require__(212);
	
	var _Log2 = _interopRequireDefault(_Log);
	
	var _Error = __webpack_require__(211);
	
	var _Error2 = _interopRequireDefault(_Error);
	
	var _ScreenRecord = __webpack_require__(214);
	...
	var main = exports.main = (function () {
	  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	    var raptor, log, error, record, configure, devicelog, configs;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 11:
	            ...
	            console.error('>>>>>>>> ERROR', _context.t0, _context.t0.stack);
	            throw _context.t0;
	...
	var DeviceLog = (function (_Command) {
	  ...
	  _createClass(DeviceLog, [{
	    ...
	    value: function run(_ref, testFilePath) {
	      ...
	      this._channelCloseDeferred = new _Defer2.default();
	      var runTest = _child_process2.default.spawn(adbPath, ['logcat'], { detached: true });
	      runTest.unref();
	      ...
	      runTest.on('close', function (status) {
	...
	var Raptor = (function (_Command) {
	  ...
	  _createClass(Raptor, [{
	    ...
	    value: function run(_ref, testFilePath) {
	      ...
	      this._channelCloseDeferred = new _Defer2.default();
	      var runTest = _child_process2.default.spawn(raptorPath, ['test', testFilePath], { detached: true });
	      runTest.unref();
	      runTest.stdout.on('data', function (data) {
	        _jsCsp2.default.putAsync(_this2._outputChannel, { 'topic': 'log', 'payload': data });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _temp = __webpack_require__(215);
		...
		_createClass(ScreenRecord, [{
			...
			value: function _runCommand(deviceTargetPath, consoleTargetPath) {
				...
				return this._channelCloseDeferred.promise.then(function () {
					...
					_child_process2.default.execFileSync(_this2._adbPath, ['pull', deviceTargetPath, consoleTargetPath]);
				});
			}
		}, {
			key: '_setPreference',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs   = __webpack_require__(207),
	    ...
	    cnst = __webpack_require__(216);
	
	var rimraf     = __webpack_require__(217),
	    osTmpdir   = __webpack_require__(219),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assert = __webpack_require__(218)
