...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Command = __webpack_require__(201);
	...
	var _Raptor = __webpack_require__(217);
	
	var _Raptor2 = _interopRequireDefault(_Raptor);
	
	var _RecordingStage = __webpack_require__(215);
	...
	var Beholder = (function () {
	  function Beholder() {
	    ...
	    this._mainModuleChannel = _jsCsp2.default.chan();
	  ...
	  _createClass(Beholder, [{
	    ...
	    value: function _initializeModules() {
	      ...
	      var initialized = {};
	      var mainModuleIdentity = this.configs.modules.__main_module__;
	      ...
	      try {
	        for (var _iterator = this.configs.modules[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var moduleIdendity = _step.value;
	
	          var module = this.modules[moduleIdendity];
	          if (!module) {
	            console.error('!!!!!!Cannot find module ' + moduleIdendity + ' from ' + this.configs.modules);
	            throw new _Error2.default('Cannot find module ' + moduleIdendity + ' from ' + this.configs.modules);
	          }
	          var afterRun = module.run(this.configs);
	          this.subscribe(module.connectToController.bind(module));
	          initialized[moduleIdendity] = { module: module, afterRun: afterRun };
	      ...
	      if (!mainModule) {
	        throw new _Error2.default('Found no main module: ' + mainModuleIdentity);
	      }
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                waitAllTerminated = Promise.all(Object.keys(this._modulesInitialized).map(function (moduleIdendity) {
	                  var _modulesInitialized$m = _this2._modulesInitialized[moduleIdendity];
	                  var module = _modulesInitialized$m.module;
	                  var afterRun = _modulesInitialized$m.afterRun;
	    ...
	    key: '_connectToMainModule',
	    value: function _connectToMainModule(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, 'status', this._mainModuleChannel);
	      this._mainModuleCloseHandler = closeHandler;
	      this._consumeStageChanges();
	    }
	  }, {
	    key: '_connectToSignals',
	    value: function _connectToSignals(publication, closeHandler) {
	        ...
	        return regeneratorRuntime.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	                _context3.next = 2;
	                return this._mainModuleChannel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _path = __webpack_require__(202);
	...
	var Command = (function () {
	  function Command(previousStageInstance) {
	  ...
	  _createClass(Command, [{
	    ...
	    value: function subscribe() {
	      ...
	      subs.forEach(function (sub) {
	        sub(_this._publication, _this.close.bind(_this));
	      });
	      return this;
	    }
	    ...
	    value: function connectToController(publication, closeHandler) {
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 3:
	                ...
	                _context2.t0 = type;
	                _context2.next = _context2.t0 === 'stagechange' ? 10 : _context2.t0 === 'initialized' ? 12 : 14;
	                break;
	    ...
	    key: '_inheritPreviousStage',
	    value: function _inheritPreviousStage(instance) {}
	  }, {
	    key: '_stopListenControlChannel',
	    value: function _stopListenControlChannel() {
	    ...
	    key: '_onInitialized',
	    value: function _onInitialized(modules) {}
	  }, {
	    key: '_onTopic',
	...
	var Configure = (function () {
	  ...
	  _createClass(Configure, [{
	    ...
	    value: function fromOptions(options) {
	      ...
	      defaultConfigs.modules.__main_module__ = options['main-module'] || defaultConfigs.modules.__main_module__ || 'raptor';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./DeviceLog": 209,
		"./DeviceLog.js": 209,
		"./DeviceLogCollectStage": 211,
		"./DeviceLogCollectStage.js": 211,
		"./Error": 212,
		"./Error.js": 212,
		"./Log/CollectingStage": 213,
		"./Log/CollectingStage.js": 213,
		"./Log/RecordingStage": 215,
		"./Log/RecordingStage.js": 215,
		"./Log/TerminatingStage": 214,
		"./Log/TerminatingStage.js": 214,
		"./Raptor": 217,
		"./Raptor.js": 217,
		"./ScreenRecord": 218,
		"./ScreenRecord.js": 218,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Command2 = __webpack_require__(201);
	...
	var DeviceLog = (function (_Command) {
	  ...
	  _createClass(DeviceLog, [{
	    ...
	    value: function run(_ref, testFilePath) {
	      ...
	      this._channelCloseDeferred = new _Defer2.default();
	      var runIt = _child_process2.default.spawn(adbPath, ['logcat'], { detached: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TerminatingStage = __webpack_require__(214);
	...
	var CollectingStage = (function (_Command) {
	  _inherits(CollectingStage, _Command);
	
	  function CollectingStage(recordingInstance) {
	    _classCallCheck(this, CollectingStage);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CollectingStage).call(this));
	
	    _this._record = recordingInstance._record;
	    return _this;
	  }
	
	  _createClass(CollectingStage, [{
	    key: 'onStageChange',
	    value: function onStageChange(stage) {
	      switch (stage) {
	        case 'terminating':
	    ...
	    value: function _transferToTerminatingStage() {
	      var terminatingStage = new _TerminatingStage2.default(this);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TerminatingStage = (function (_Command) {
	  _inherits(TerminatingStage, _Command);
	
	  function TerminatingStage() {
	    _classCallCheck(this, TerminatingStage);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TerminatingStage).call(this));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LogRecord = __webpack_require__(216);
	
	var _LogRecord2 = _interopRequireDefault(_LogRecord);
	
	var _CollectingStage = __webpack_require__(213);
	...
	var RecordingStage = (function (_Command) {
	  _inherits(RecordingStage, _Command);
	
	  function RecordingStage() {
	    _classCallCheck(this, RecordingStage);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RecordingStage).call(this));
	
	    _this._record = new _LogRecord2.default();
	
	    _this._logsPublication = null;
	    _this._topicLog = 'log';
	    _this._devicelogChannel = _jsCsp2.default.chan();
	    return _this;
	  }
	  ...
	  _createClass(RecordingStage, [{
	    key: 'connectToLogs',
	    value: function connectToLogs(publication) {
	    ...
	    key: '_onInitialized',
	    value: function _onInitialized(modules) {
	      modules.devicelog.subscribe(this.connectToLogs.bind(this));
	    }
	  }, {
	    key: '_onLog',
	    ...
	    value: function _stop() {
	      _jsCsp2.default.operations.pub.unsub(this._logsPublication, this._topicLog, this._devicelogChannel);
	    }
	  }, {
	    key: '_transferToCollectingStage',
	    value: function _transferToCollectingStage() {
	      var collectingStage = new _CollectingStage2.default(this);
	    }
	  }, {
	    key: '_transferToTerminatingStage',
	    value: function _transferToTerminatingStage() {
	...
	var Raptor = (function (_Command) {
	  ...
	  _createClass(Raptor, [{
	    ...
	    value: function run(_ref, testFilePath) {
	      ...
	      this._channelCloseDeferred = new _Defer2.default();
	      var runIt = _child_process2.default.spawn(raptorPath, ['test', testFilePath], { detached: true });
	      runIt.unref();
	      runIt.stdout.on('data', function (data) {
	        _jsCsp2.default.putAsync(_this2._outputChannel, { 'topic': 'log', 'payload': data });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _os = __webpack_require__(219);
