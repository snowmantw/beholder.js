...
/***/ function(module, exports, __webpack_require__) {
	...
	var main = exports.main = (function () {
	  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	    var raptor, log, error, record, configure, devicelog, configs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, moduleIdendity, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, testFilePath;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 15:
	            ...
	            _context.next = _context.t0 === 'adb' ? 20 : _context.t0 === 'raptor' ? 22 : 42;
	            break;
	
	          case 20:
	            devicelog.subscribe(log.connect.bind(log), error.errorFromLogChannel.bind(error), error.errorFromErrorChannel.bind(error)).run(configs);
	          ...
	          case 22:
	            ...
	            for (_iterator2 = configs.tests[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	              testFilePath = _step2.value;
	
	              raptor.subscribe(log.connect.bind(log), error.connect.bind(error)).
	          ...
	          case 61:
	            ...
	            console.error('>>>>>>>> ERROR', _context.t3, _context.t3.stack);
	            throw _context.t3;
	    ...
	    }, _callee, this, [[0, 61], [13, 47, 51, 59], [25, 29, 33, 41], [34,, 36, 40], [52,, 54, 58]]);
	  }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Configure = (function () {
	  function Configure() {
	    ...
	    this.opts = _nodeGetopt2.default.create([['r', 'raptor=ARG', 'where the raptor executable file is'], ['p', 'phase=ARG', 'where the running phase is'], ['c', 'config=ARG', 'config file (command line arguments will surpass it)'], ['', 'adb=ARG', 'where the `adb` command is`'], ['m', 'modules=ARG+', 'invoke what modules'], ['h', 'help', 'display this help'], ['v', 'version', 'show version']]).bindHelp('Usage: beholder <test-file-path> --<optional options>');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScreenRecord = (function (_Command) {
	  ...
	  function ScreenRecord() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ScreenRecord).call(this));
	  }
