...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Command = __webpack_require__(191);
	
	var _Command2 = _interopRequireDefault(_Command);
	
	var _Configure = __webpack_require__(204);
	
	var _Configure2 = _interopRequireDefault(_Configure);
	
	var _Raptor = __webpack_require__(215);
	...
	var _ScreenRecord = __webpack_require__(216);
	
	var _ScreenRecord2 = _interopRequireDefault(_ScreenRecord);
	
	var _DeviceLog = __webpack_require__(210);
	
	var _DeviceLog2 = _interopRequireDefault(_DeviceLog);
	
	var _Signal = __webpack_require__(223);
	
	var _Signal2 = _interopRequireDefault(_Signal);
	
	var _Upstream = __webpack_require__(224);
	
	var _Upstream2 = _interopRequireDefault(_Upstream);
	
	var _Foo = __webpack_require__(213);
	
	var _Foo2 = _interopRequireDefault(_Foo);
	
	var _Bar = __webpack_require__(209);
	...
	var main = exports.main = (function () {
	  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	    var raptor, log, error, record, configure, devicelog, signal, upstream, foo, bar, configs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, moduleIdendity;
	    ...
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            _context.prev = 0;
	            raptor = new _Raptor2.default();
	            log = new _Log2.default();
	            error = new _Error2.default();
	            record = new _ScreenRecord2.default();
	            configure = new _Configure2.default();
	            devicelog = new _DeviceLog2.default();
	            signal = new _Signal2.default();
	            upstream = new _Upstream2.default();
	            foo = new _Foo2.default();
	            bar = new _Bar2.default();
	            configs = configure.setup();
	            ...
	            //record.run(configs);
	            //
	            upstream.subscribe(foo.connect.bind(foo), bar.connect.bind(bar));
	
	            _iteratorNormalCompletion = true;
	            _didIteratorError = false;
	            _iteratorError = undefined;
	            _context.prev = 17;
	            _iterator = configs.modules[Symbol.iterator]();
	          ...
	          case 19:
	            ...
	            moduleIdendity = _step.value;
	            _context.t0 = moduleIdendity;
	            _context.next = _context.t0 === 'adb' ? 24 : _context.t0 === 'screenrecord' ? 25 : 26;
	            break;
	          ...
	          case 45:
	            ...
	            console.error('>>>>>>>> ERROR', _context.t2, _context.t2.stack);
	            throw _context.t2;
	    ...
	    }, _callee, this, [[0, 45], [17, 31, 35, 43], [36,, 38, 42]]);
	  }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsCsp = __webpack_require__(193);
	
	var _jsCsp2 = _interopRequireDefault(_jsCsp);
	
	var _Defer = __webpack_require__(203);
	...
	var Command = (function () {
	  ...
	  _createClass(Command, [{
	    key: 'run',
	    value: function run() {
	      this._channelCloseDeferred = new _Defer2.default();
	    ...
	    value: function subscribe() {
	      ...
	      var publication = _jsCsp2.default.operations.pub(this._outputChannel, function (e) {
	        return e.topic;
	      });
	      ...
	      subs.forEach(function (sub) {
	        sub(publication, _this.close.bind(_this));
	      });
	      return this;
	    }
	    ...
	    key: 'connect',
	    value: function connect(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, this._topic, this._inputChannel);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var csp = __webpack_require__(194);
	var operations = __webpack_require__(201);
	var pipeline = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buffers = __webpack_require__(195);
	var channels = __webpack_require__(196);
	var select = __webpack_require__(198);
	var process = __webpack_require__(199);
	var timers = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buffers = __webpack_require__(195);
	var dispatch = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Box = __webpack_require__(196).Box;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dispatch = __webpack_require__(197);
	var select = __webpack_require__(198);
	var Channel = __webpack_require__(196).Channel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeGetopt = __webpack_require__(205);
	
	var _nodeGetopt2 = _interopRequireDefault(_nodeGetopt);
	
	var _fs = __webpack_require__(207);
	...
	var Configure = (function () {
	  function Configure() {
	    ...
	    this.opts = _nodeGetopt2.default.create([['r', 'raptor=ARG', 'where the raptor executable file is'], ['p', 'phase=ARG', 'where the running phase is'], ['c', 'config=ARG', 'config file (command line arguments will surpass it)'], ['', 'adb=ARG', 'where the `adb` command is`'], ['', 'record-target-device=ARG', 'where to put the record on the device'], ['', 'record-target-console=ARG', 'where to pull the record to the console'], ['m', 'modules=ARG+', 'invoke what modules'], ['h', 'help', 'display this help'], ['v', 'version', 'show version']]).bindHelp('Usage: beholder <test-file-path> --<optional options>');
	  }
	  ...
	  _createClass(Configure, [{
	    ...
	    value: function validateModuleCommands(configs) {
	      ...
	      try {
	        for (var _iterator = configs.modules[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var moduleIdendity = _step.value;
	    ...
	    value: function fromOptions(options) {
	      ...
	      if (options.config) {
	        defaultConfigs = __webpack_require__(208)(options.config);
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bar = (function () {
	  function Bar() {
	    ...
	    this._defer = new _Defer2.default();
	    this._channel = _jsCsp2.default.chan();
	  }
	
	  _createClass(Bar, [{
	    key: 'connect',
	    value: function connect(publication, closeHandler) {
	      console.log('>>>>> bar::connect called');
	      _jsCsp2.default.operations.pub.sub(publication, 'data', this._channel);
	      this._upstreamCloser = closeHandler;
	      this.consume();
	    }
	  }, {
	    key: 'consume',
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 3:
	                ...
	                console.log('>>>>>> Bar received value: ', value.payload);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _child_process = __webpack_require__(211);
	...
	var _Command2 = __webpack_require__(191);
	...
	var DeviceLog = (function (_Command) {
	  _inherits(DeviceLog, _Command);
	
	  function DeviceLog() {
	    _classCallCheck(this, DeviceLog);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeviceLog).call(this));
	  }
	
	  _createClass(DeviceLog, [{
	    key: 'run',
	    value: function run(_ref, testFilePath) {
	      var adbPath = _ref.path.adb;
	      ...
	      */
	      ...
	      return this._channelCloseDeferred.promise.then(function () {
	    ...
	    key: 'connectSignals',
	    value: function connectSignals(publication, closeHandler) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Error = (function (_Command) {
	  _inherits(Error, _Command);
	  ...
	  function Error() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Error).call(this));
	
	    _this._topicLog = 'log';
	    _this._topicError = 'error';
	    return _this;
	  }
	  ...
	  _createClass(Error, [{
	    key: 'errorFromLogChannel',
	    value: function errorFromLogChannel(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, this._topicLog, this._inputChannel);
	    ...
	    key: 'errorFromErrorChannel',
	    value: function errorFromErrorChannel(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, this._topicError, this._inputChannel);
	      this.consumeError(this._onStandardError.bind(this));
	    }
	  }, {
	    key: '_onStandardError',
	    value: function _onStandardError(value) {
	      //console.log('>>> STANDARD ERROR: ', value.payload.toString());
	    }
	  }, {
	    key: '_onPossibleLoggedError',
	    value: function _onPossibleLoggedError(value) {
	      var log = value.payload.toString();
	    ...
	    key: 'consumeError',
	    value: function consumeError(handler) {
	      _jsCsp2.default.go(regeneratorRuntime.mark(function _callee() {
	        var value;
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Foo = (function () {
	  ...
	  _createClass(Foo, [{
	    key: 'connect',
	    value: function connect(publication, closeHandler) {
	      console.log('>>>>> foo::connect called');
	      _jsCsp2.default.operations.pub.sub(publication, 'data', this._channel);
	      this._upstreamCloser = closeHandler;
	      this.consume();
	    }
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 3:
	                ...
	                console.log('>>>>>> Foo received value: ', value.payload);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Log = (function (_Command) {
	  _inherits(Log, _Command);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Raptor = (function (_Command) {
	  _inherits(Raptor, _Command);
	
	  function Raptor() {
	    _classCallCheck(this, Raptor);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Raptor).call(this));
	  }
	  ...
	  _createClass(Raptor, [{
	    ...
	    value: function run(_ref, testFilePath) {
	      ...
	      var phasePath = _ref$path.phase;
	      var raptorPath = _ref$path.raptor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _os = __webpack_require__(217);
	...
	var ScreenRecord = (function (_Command) {
		_inherits(ScreenRecord, _Command);
	
		function ScreenRecord() {
			_classCallCheck(this, ScreenRecord);
	
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ScreenRecord).call(this));
		...
		_createClass(ScreenRecord, [{
			...
			value: function run(_ref) {
				var _ref$path = _ref.path;
				var adbPath = _ref$path.adb;
				var _ref$path$record$targ = _ref$path.record.target;
				var deviceTargetPath = _ref$path$record$targ.device;
				var consoleTargetPath = _ref$path$record$targ.console;
			...
			value: function _putPreferences(preferences) {
				...
				try {
					...
					_fs2.default.access(this._preferencesTempFilePath, _fs2.default.F_OK, function (accessError) {
						if (!accessError) {
							_fs2.default.unlinkSync(_this2._preferencesTempFilePath);
						}
					});
				}
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs   = __webpack_require__(207),
	    path = __webpack_require__(192),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Signal = (function (_Command) {
	  _inherits(Signal, _Command);
	
	  function Signal() {
	    _classCallCheck(this, Signal);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Signal).call(this));
	  }
	    ...
	    value: function run() {
	      ...
	      signals.forEach(function (signal) {
	        process.on(signal, function () {
	          _jsCsp2.default.putAsync(_this2._outputChannel, { 'topic': 'data', 'payload': 'termination' });
	        });
	      });
	      this._channelCloseDeferred = new _Defer2.default();
	      return this._channelCloseDeferred.promise.then(function () {
	...
	var Upstream = (function () {
	  ...
	  _createClass(Upstream, [{
	    ...
	    value: function run() {
	      this._runInterval();
	      this._runSignals();
	      this._defer.promise = this._defer.promise.then(function () {
	        console.log('>>>>>> exit: ');
	        process.exit();
	      });
	    }
	    ...
	    key: '_runInterval',
	    value: function _runInterval() {
	      var _this = this;
	
	      setInterval(function () {
	        console.log('<<<<<<< put in Upstream');
	        _jsCsp2.default.putAsync(_this._channel, { 'topic': 'data', 'payload': 'tick' });
	      }, 200);
	    }
	  }, {
	    key: '_runSignals',
	    value: function _runSignals() {
	      var _this2 = this;
	
	      var signals = ['SIGHUP', 'SIGINT', 'SIGTERM'];
	      signals.forEach(function (signal) {
	        process.on(signal, function () {
	          _jsCsp2.default.putAsync(_this2._channel, { 'topic': 'data', 'payload': 'termination' });
	        });
	      });
	    }
	  }, {
	    ...
	    value: function subscribe() {
	      ...
	      var publication = _jsCsp2.default.operations.pub(this._channel, function (e) {
	        return e.topic;
	      });
	      ...
	      subs.forEach(function (sub) {
	        sub(publication, _this3.close.bind(_this3));
	      });
	      return this;
	    }
	  }, {
