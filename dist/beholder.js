...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Signal = __webpack_require__(224);
	...
	var _ScreenRecord = __webpack_require__(217);
	
	var _ScreenRecord2 = _interopRequireDefault(_ScreenRecord);
	
	var _Timeline = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./routers/Log/CollectingStage": 214,
		"./routers/Log/CollectingStage.js": 214,
		"./routers/Log/RecordingStage": 216,
		"./routers/Log/RecordingStage.js": 216,
		"./routers/Log/TerminatingStage": 215,
		"./routers/Log/TerminatingStage.js": 215,
		"./routers/Router": 213,
		"./routers/Router.js": 213,
		"./routers/ScreenRecord": 217,
		"./routers/ScreenRecord.js": 217,
		"./routers/Signal": 224,
		"./routers/Signal.js": 224,
		"./routers/Timeline": 225,
		"./routers/Timeline.js": 225
	};
...
/***/ function(module, exports) {
	...
	var Timeline = function () {
	  ...
	  _createClass(Timeline, [{
	    key: 'push',
	    value: function push(source, data) {
	...
	var DeviceLog = function (_Router) {
	  ...
	  _createClass(DeviceLog, [{
	    ...
	    value: function _recording(defer) {
	      ...
	      var runIt = _child_process2.default.spawn(this._adbPath, ['logcat', '-v', 'time'], { env: { 'TZ': 'Etc/UTC' }, detached: true });
	      runIt.unref();
	      runIt.stdout.on('data', function (data) {
	        var lines = _this2._splitLines(data.toString());
	        lines.map(function (line) {
	          ...
	          var timeOffsetLine = _this2._timeOffsetFromDateTime(line);
	          // Something makes it cannot be marked.
	          if (!timeOffsetLine) {
	            return;
	          }
	          console.log(':::::::::::: line: ', timeOffsetLine);
	          _jsCsp2.default.putAsync(_this2._outputChannel, { 'topic': 'log', 'source': _this2._name,
	    ...
	    value: function _timeOffsetFromDateTime(data) {
	      var _data$split = data.split(' ');
	
	      var _data$split2 = _toArray(_data$split);
	
	      var date = _data$split2[0];
	      var time = _data$split2[1];
	
	      var others = _data$split2.slice(2);
	
	      console.log('date, time, others: {', date, '}', '{', time, '} -- ', data);
	      var offset = this._epochTimeFromDateTime(this._deviceYear, date, time) - this._initialEpoch;
	      if (isNaN(offset)) {
	        return;
	      }
	    ...
	    value: function _epochTimeFromDateTime(year, date, time) {
	    ...
	    value: function _fetchInitialEpoch() {
	      var initialEpoch = (0, _AndroidDaemonBus.commandDevice)(this._adbPath)('shell', 'TZ=Etc/UTC', 'date', '"+%s"');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TerminatingStage = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CollectingStage = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _temp = __webpack_require__(218);
	
	var _temp2 = _interopRequireDefault(_temp);
	
	var _os = __webpack_require__(223);
	...
	var ScreenRecord = function (_Router) {
	  ...
	  _createClass(ScreenRecord, [{
	    ...
	    value: function _recording(defer) {
	      ...
	      runIt.unref();
	      runIt.stdout.on('data', function (data) {
	        _jsCsp2.default.putAsync(_this2._outputChannel, { 'topic': 'log', 'source': _this2._name, 'payload': data });
	      });
	      runIt.stderr.on('data', function (data) {
	        _jsCsp2.default.putAsync(_this2._outputChannel, { 'topic': 'error', 'source': _this2._name, 'payload': data });
	      });
	      runIt.on('close', function (status) {
	    ...
	    key: '_terminating',
	    value: function _terminating(defer) {
	      _jsCsp2.default.putAsync(this._outputChannel, { 'topic': 'data', 'source': this._name, 'payload': this._pathExtractedFrames });
	    }
	  }, {
	    key: '_setPreference',
	    ...
	    value: function _fetchPreferences(preferencePath) {
	      ...
	      var strPrefs = (0, _AndroidDaemonBus.commandDevice)(this._adbPath)('shell', 'cat', preferencePath).toString();
	      try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs   = __webpack_require__(204),
	    ...
	    cnst = __webpack_require__(219);
	
	var rimraf     = __webpack_require__(220),
	    osTmpdir   = __webpack_require__(222),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timeline = function (_Router) {
	  ...
	  _createClass(Timeline, [{
	    ...
	    key: '_onInitialized',
	    value: function _onInitialized(routers) {
	      var _this2 = this;
	
	      _get(Object.getPrototypeOf(Timeline.prototype), '_onInitialized', this).apply(this, arguments);
	      Object.keys(routers).forEach(function (name) {
	        var router = routers[name];
	        switch (name) {
	          case 'screenrecord':
	          case 'devicelog':
	            router.subscribe(_this2._connect);
	            break;
	        }
	      });
	    }
	    ...
	    value: function _connect(publication) {
	      _jsCsp2.default.operations.pub.sub(publication, 'log', this._input);
	      _jsCsp2.default.operations.pub.sub(publication, 'error', this._input);
	    ...
	    value: function _onInput(value) {
	      ...
	      var _value$payload$detail = value.payload.detail;
	      var timestamp = _value$payload$detail.timestamp;
	      var data = _value$payload$detail.data;
	
	      if (!this._timeline[timestamp]) {
	        this._timeline[timestamp] = new _Timeline2.default(timestamp);
	      }
