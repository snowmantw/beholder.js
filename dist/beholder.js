...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function (_Router) {
	  ...
	  _createClass(Controller, [{
	            ...
	            switch (_context.prev = _context.next) {
	              ...
	              case 3:
	                ...
	                return Promise.all(currentStagePromises).then(function () {
	                  console.log('>> in promises final, wait all done');
	                });
	    ...
	    value: function _consumeMainRouterMessage() {
	      var fn = regeneratorRuntime.mark(function fn() {
	        var value;
	        return regeneratorRuntime.wrap(function fn$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 4:
	                if (!(value !== _jsCsp2.default.CLOSED)) {
	                  _context2.next = 12;
	                  break;
	                }
	      ...
	      _jsCsp2.default.go(fn.bind(this));
	    }
	  }, {
	    ...
	    value: function () {
	        ...
	        return regeneratorRuntime.wrap(function _callee2$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	                _context3.prev = 0;
	                _currentStagePromises = Object.keys(this._routers).map(function (name) {
	                  var router = _this3._routers[name];
	                ...
	                _context3.next = 6;
	                return Promise.all(_currentStagePromises);
	      ...
	      return function _forwardStageChangeRequest(_x) {
	        return ref.apply(this, arguments);
	      };
	    }()
	  }]);
