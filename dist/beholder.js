...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Configure = __webpack_require__(191);
	
	var _Configure2 = _interopRequireDefault(_Configure);
	
	var _Raptor = __webpack_require__(208);
	...
	var _ScreenRecord = __webpack_require__(223);
	...
	var main = exports.main = (function () {
	  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	    var raptor, log, errro, record, configure, configs;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeGetopt = __webpack_require__(192);
	...
	var Configure = (function () {
	  function Configure() {
	    ...
	    this.opts = _nodeGetopt2.default.create([['r', 'raptor=ARG', 'where the raptor executable file is'], ['p', 'phase=ARG', 'where the running phase is'], ['c', 'config=ARG', 'config file (command line arguments will surpass it)'], ['h', 'help', 'display this help'], ['v', 'version', 'show version']]).bindHelp('Usage: beholder <test-file-path> --<optional options>');
	  }
	
	  _createClass(Configure, [{
	    key: 'setup',
	    value: function setup() {
	      this.validate.apply(this, _toConsumableArray(this.getopts()));
	    }
	    ...
	    key: 'validate',
	    value: function validate(argv, options) {
	    ...
	    value: function fromOptions(options) {
	      ...
	      if (options.config) {
	        defaultConfigs = __webpack_require__(195)(options.config);
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsCsp = __webpack_require__(197);
	...
	var Error = (function () {
	  function Error() {
	    ...
	    this._logChannel = _jsCsp2.default.chan();
	  }
	
	  _createClass(Error, [{
	    key: 'connect',
	    value: function connect(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, 'error', this._logChannel);
	    }
	  }, {
	    key: 'consume',
	    value: regeneratorRuntime.mark(function consume() {
	      var value;
	      return regeneratorRuntime.wrap(function consume$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              _context.next = 2;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var csp = __webpack_require__(198);
	var operations = __webpack_require__(205);
	var pipeline = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buffers = __webpack_require__(199);
	var channels = __webpack_require__(200);
	var select = __webpack_require__(202);
	var process = __webpack_require__(203);
	var timers = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buffers = __webpack_require__(199);
	var dispatch = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Box = __webpack_require__(200).Box;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dispatch = __webpack_require__(201);
	var select = __webpack_require__(202);
	var Channel = __webpack_require__(200).Channel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Log = (function () {
	  ...
	  _createClass(Log, [{
	    key: 'connect',
	    value: function connect(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, 'log', this._logChannel);
	    }
	  }, {
	    key: 'consume',
	    value: regeneratorRuntime.mark(function consume() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _path = __webpack_require__(209);
	...
	var _Defer = __webpack_require__(211);
	...
	var Raptor = (function () {
	  ...
	  _createClass(Raptor, [{
	    ...
	    value: function setup(_ref) {
	      ...
	      var testFilePath = _ref$path.test;
	
	      var runTest = _child_process2.default.spawn(raptorPath, ['test', testFilePath], { 'env': { 'RUNNING_PHASE': phasePath } });
	      runTest.stdout.on('data', function (data) {
	        return _jsCsp2.default.putAsync(_this._channel, { 'topic': 'log', 'payload': data });
	      });
	      runTest.stderr.on('data', function (data) {
	        return _jsCsp2.default.putAsync(_this._channel, { 'topic': 'error', 'payload': data });
	      });
	      return this;
	    }
	    ...
	    value: function subscribe() {
	      ...
	      runTest.on('close', function (status) {
	        _jsCsp2.default.putAsync(_this2._channel, { 'topic': 'status', 'payload': status });
	      });
	      ...
	      subs.forEach(function (sub) {
	        sub(publication, _this2.close.bind(_this2));
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asap = __webpack_require__(215);
	...
	function requestFlush() {
	    ...
	    if (parentDomain) {
	        if (!domain) {
	            ...
	            domain = __webpack_require__(216);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promise = __webpack_require__(214);
	var asap = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScreenRecord = (function () {
	  function ScreenRecord() {
	    ...
	    this._recordChannel = _jsCsp2.default.chan();
	  }
	
	  _createClass(ScreenRecord, [{
	    key: 'connect',
	    value: function connect(publication, closeHandler) {
	      _jsCsp2.default.operations.pub.sub(publication, 'log', this._recordChannel);
	    }
	  }, {
	    key: 'consume',
	    value: regeneratorRuntime.mark(function consume() {
