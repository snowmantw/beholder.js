	...
	var DeviceLog = function (_Router) {
	  ...
	  _createClass(DeviceLog, [{
	    ...
	    value: function _fetchTimeInformation() {
	      ...
	      this._deviceTZ = this._commandDevice('shell', 'getprop', 'persist.sys.timezone').toString().trim();
	    ...
	    value: function _recording(defer) {
	      ...
	      runIt.stderr.on('data', function (chunk) {
	        _this2._errors.push(chunk.toString());
	      });
	    ...
	    value: function _fetchInitialEpoch() {
	      var seconds = parseFloat(this._commandDevice('shell', 'echo', '$EPOCHREALTIME').toString().trim(), 10);
