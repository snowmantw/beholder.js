	...
	var Router = function () {
	  ...
	  _createClass(Router, [{
	    ...
	    value: function _transferTo(stageMethod) {
	      ...
	      //
	      this._stages.promise = this._stages.promise.then(_asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	              ...
	              case 3:
	                return _context2.abrupt('return', this._currentStageDefer.promise);
